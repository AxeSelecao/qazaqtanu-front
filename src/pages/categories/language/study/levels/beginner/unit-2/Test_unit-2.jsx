...
function Test_Unit2() {
  ...
  if (num == 1) {
    answers = data[0].units[1].materials[1].answers;
  } else if (num == 2) {
    answers = data[0].units[1].materials[3].answers;
  }
  ...
  const checkAnswer = () => {
    ...
    axios.get(`http://localhost:8000/user/${profileData._id}`).then((res) => {
      if (
        !res.data.results[0].units[1].materials[1].completed ||
        !res.data.results[0].units[1].materials[3].completed
      ) {
        ...
        if (num == 1) {
          handleMakeComplete({
            unit_name: "unit-2",
            material_id: "64330cbc6d750381a252905a",
          });
        } else if (num == 2) {
          handleMakeComplete({
            unit_name: "unit-2",
            material_id: "64330cef6d750381a252905b",
          });
        }
      }
    });
      ...
      <div className="unit">
        <div className="unit__container">
          ...
          <div className="unit__test">
            {data[0].units[1].materials[1].items.map((item, i) => {
              return (
                <div className="unit__test-item">
                  ...
                  <div className="unit__test-answers">
                    {data[0].units[1].materials[1].items[i].answer_options.map(
                      (option) => {
                        return (
                          <div
    ...
    return (
      <div className="unit">
        <div className="unit__container">
          ...
          <div className="unit__test">
            {data[0].units[1].materials[3].items.map((item, i) => {
              return (
                <div className="unit__test-item">
                  <div className="unit__test-question">
                    <h2
                  ...
                  <div className="unit__test-answers">
                    {data[0].units[1].materials[3].items[i].answer_options.map(
                      (option) => {
                        return (
                          <div
                            className="unit__test-answer-option pointer"
